...
hanjaArea.text(180, 80, '1 / 13').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '工 夫').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(90, 305, ['장인 ', '공']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(180, 305, ['지아비 ', '부']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(50, 395, ['내 동생은 ', '工夫', '를 잘하는 편입니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
