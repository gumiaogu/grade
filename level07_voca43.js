...
function handlerPre() {
  location.replace('level07_voca42.html');
}
...
hanjaArea.text(180, 80, '43 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '活 動').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(110, 305, ['살 ', '활']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(180, 305, ['움직일 ', '동']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['박쥐는 밤에 ', '活動', '하는 동물입니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
