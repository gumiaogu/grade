...
function handlerPre() {
  location.replace('level07_voca29.html');
}
...
hanjaArea.text(180, 80, '30 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '自 然').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(95, 305, ['스스로 ', '자']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(200, 305, ['그럴 ', '연']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['우리나라의 아름다운 ', '自然', '을 잘', '보존해야 합니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
