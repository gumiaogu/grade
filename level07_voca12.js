...
hanjaArea.text(180, 80, '12 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '符 號').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(100, 305, ['부신 ', '부']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['국어 시간에 ‘원고지 문장 ', '符號', '’를', '배웠습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
