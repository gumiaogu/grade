...
hanjaArea.text(180, 80, '29 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '姿 勢').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(105, 305, ['맵시 ', '자']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(195, 305, ['권세 ', '세']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['태권도의 기본 ', '姿勢', '를 배웠습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
