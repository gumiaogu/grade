...
hanjaArea.text(180, 80, '11 / 13').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '注 意').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(100, 305, ['물댈 ', '주']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(200, 305, ['뜻 ', '의']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['동생은 부모님의 말씀을 ', '注意', ' 깊게', '듣고 있습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
