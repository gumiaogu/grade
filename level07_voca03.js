...
hanjaArea.text(180, 80, '3 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '敎 室').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(90, 305, ['가르칠 ', '교']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(200, 305, ['집 ', '실']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['수업이 끝나고 ', '敎室', ' 청소를 하였습', '니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
