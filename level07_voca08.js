...
hanjaArea.text(180, 80, '8 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '發 音').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(110, 305, ['필 ', '발']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(185, 305, ['소리 ', '음']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['아나운서의 ', '發音', '은 정확합니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
