...
var Library = {
  ...
  Generate: function(params) {
    ...
    this.generate = function() {
      ...
      this.hanjaTango = conData[0].hanjaTango;
      this.goyi = conData[0].goyi;

      var que = type === 0 ? this.hanjaTango : this.goyi;
    ...
    function makeChoice(que) {
      ...
      var answer = type === 0 ? data[answerIndex].goyi : data[answerIndex].hanjaTango;
    ...
    function getChoiceData(que) {
      ...
      for (var i = 0; i < copyData.length; i++) {
        if (type === 0) {
          if (i !== answerIndex) {
            newData.push(copyData[i].goyi);
          }
        } else {
          if (i !== answerIndex) {
            newData.push(copyData[i].hanjaTango);
          }
        }
      }
  ...
  choiceCheck: function(params) {
    ...
    function handler() {
      ...
      if (check) {
        ...
        // 틀렸을 때, 정답 버튼 효과
        setTimeout(function() {
         handler2(choices[rightAnswer], '#adcf9eff');
        }, 500);
      }
