...
hanjaArea.text(180, 80, '15 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '想 像').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(100, 305, ['생각 ', '상']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(190, 305, ['형상 ', '상']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['나의 미래를 ', '想像', '하며 글짓기를', '하였습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
