...
function handlerPre() {
  location.replace('level07_voca22.html');
}
...
hanjaArea.text(180, 80, '23 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '實 感').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(100, 305, ['열매 ', '실']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(190, 305, ['느낄 ', '감']).attr({
  'font-size': 20,
  'fill': '#999999'
});
