...
function handlerPre() {
  location.replace('level07_voca17.html');
}
...
hanjaArea.text(180, 80, '18 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(155, 305, ['글 ', '시']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['선생님께서 아름다운 ', '詩', ' 한 편을', '들려주셨습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
