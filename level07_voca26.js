...
hanjaArea.text(180, 80, '26 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '午 前').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m2 = hanjaArea.text(195, 305, ['앞 ', '전']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['오늘은 ', '午前', ' 수업만 하고 끝납니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
