...
hanjaArea.text(180, 80, '40 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '學 年').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(105, 305, ['배울 ', '학']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(200, 305, ['해 ', '년']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['동생은 나보다 두 ', '學年', ' 아래입니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
