...
hanjaArea.text(180, 80, '21 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(152, 305, ['법 ', '식']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['式', '을 잘 세워야 응용문제를 잘 풀 수', '있습니다.']).attr({
  'font-size': 28,
  'fill': '#434343',
  'font-weight': 'bold',
});
