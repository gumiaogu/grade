...
function handlerPre() {
  location.replace('level08_voca03.html');
}
...
hanjaArea.text(180, 80, '4 / 13').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '文 章').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(100, 305, ['글월 ', '문']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(200, 305, ['글 ', '장']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['영어 ', '文章', '을 하루에 하나씩 외우기', '로 하였습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
