...
function handlerPre() {
  location.replace('level07_voca27.html');
}
...
hanjaArea.text(180, 80, '28 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(145, 305, ['둥글 ', '원']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['컴퍼스는 ', '圓', '을 그릴 때 사용하는', '도구입니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
