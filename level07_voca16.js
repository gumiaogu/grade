...
hanjaArea.text(180, 80, '16 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(155, 305, ['줄 ', '선']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['달리기를 하기 위해 출발', '線', '에 섰습', '니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
