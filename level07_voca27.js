...
function handlerAft() {
  location.replace('level07_voca28.html');
}

vocaCard.use().transform('t30, 100').appendTo(topBox);

hanjaArea.text(180, 80, '27 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '午 後').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(115, 305, ['낮 ', '오']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(195, 305, ['뒤 ', '후']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['午後', '에 누나와 함께 수영장에 갔습', '니다.']).attr({
  'font-size': 28,
  'fill': '#434343',
  'font-weight': 'bold',
});
