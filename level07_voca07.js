...
hanjaArea.text(180, 80, '7 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '民 俗').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(100, 305, ['백성 ', '민']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(190, 305, ['풍속 ', '속']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['설날에 온 가족이 모여 여러 가지 ', '民俗', ' 놀이를 했습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
