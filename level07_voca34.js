...
hanjaArea.text(180, 80, '34 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '正 確').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m2 = hanjaArea.text(190, 305, ['굳을 ', '확']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['책을 펴고 또박또박 ', '正確', '한 발음', '으로 소리 내어 읽었습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
