...
function handlerPre() {
  location.replace('level08_voca01.html');
}
...
hanjaArea.text(180, 80, '2 / 13').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '內 容').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(110, 305, ['안 ', '내']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(185, 305, ['얼굴 ', '용']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['이어질  ', '內容', '을 생각하며 책을 읽어', '봅시다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
