...
function handlerPre() {
  location.replace('level08_voca04.html');
}
...
hanjaArea.text(180, 80, '5 / 13').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '事 物').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(110, 305, ['일 ', '사']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(185, 305, ['물건 ', '물']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['우리 주변의 물건들을 ', '事物', '이라고','합니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
