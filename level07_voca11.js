...
hanjaArea.text(180, 80, '11 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(155, 305, ['가 ', '변']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(50, 395, ['정삼각형은 세 ', '邊', '의 길이가 같습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
