...
function handlerPre() {
  location.replace('level07_voca19.html');
}
...
hanjaArea.text(180, 80, '20 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '時 計').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m2 = hanjaArea.text(195, 305, ['셀 ', '계']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 390, ['時計', '를 보니 벌써 아홉 시가 넘었', '습니다.']).attr({
  'font-size': 28,
  'fill': '#434343',
  'font-weight': 'bold',
});
