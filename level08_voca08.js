...
function handlerAft() {
  location.replace('level08_voca09.html');
}

vocaCard.use().transform('t30, 100').appendTo(topBox);

hanjaArea.text(180, 80, '8 / 13').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '植 物').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(95, 305, ['심을 ', '식']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(190, 305, ['물건 ', '물']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['동물과 ', '植物', '의 차이점을 이야기', '하여 봅시다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
