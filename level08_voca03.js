...
function handlerPre() {
  location.replace('level08_voca02.html');
}
...
hanjaArea.text(180, 80, '3 / 13').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '動 物').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(85, 305, ['움직일 ', '동']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['이  ', '動物', '의 이름은 오랑우탄입니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
