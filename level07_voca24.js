...
function handlerAft() {
  location.replace('level07_voca25.html');
}

vocaCard.use().transform('t30, 100').appendTo(topBox);

hanjaArea.text(180, 80, '24 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '安 全').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(85, 305, ['편안할 ', '안']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(190, 305, ['온전할 ', '전']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(50, 390, ['차례를 지키면 ', '安全', '하고 편리합니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
