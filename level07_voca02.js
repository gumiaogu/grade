...
hanjaArea.text(180, 80, '2 / 43').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '計 劃').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(105, 305, ['셀 ', '계']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m2 = hanjaArea.text(190, 305, ['그을 ', '획']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['방학동안 무엇을 할지 ', '計劃', '을 세워', '보았습니다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
