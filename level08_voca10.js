...
hanjaArea.text(180, 80, '10 / 13').attr({
  'font-size': 20,
  'fill': '#666666',
  'text-anchor': 'middle'
});
...
hanjaArea.text(180, 220, '人 物').attr({
  'font-size': 70,
  'text-anchor': 'middle'
});
...
var m1 = hanjaArea.text(100, 305, ['사람 ', '인']).attr({
  'font-size': 20,
  'fill': '#999999'
});
...
var m3 = hanjaArea.text(55, 395, ['다음 이야기에 나오는 ', '人物', '들에게', '편지를 써봅시다.']).attr({
  'font-size': 18,
  'fill': '#434343'
});
